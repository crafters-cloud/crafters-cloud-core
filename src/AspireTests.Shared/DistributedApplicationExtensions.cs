...
namespace CraftersCloud.Core.AspireTests.Shared;
...
public static partial class DistributedApplicationExtensions
{
    ...
    public static TBuilder RemoveResource<TBuilder>(this TBuilder builder, string resourceName)
        where TBuilder : IDistributedApplicationTestingBuilder
    {
        var resource = builder.Resources.FirstOrDefault(r => r.Name == resourceName);
        if (resource != null)
        {
