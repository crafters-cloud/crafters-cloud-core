...
public static class HealthChecksStartupExtensions
{
    ...
    public static void AppAddHealthChecks<T>(this IServiceCollection services, IConfiguration configuration,
        Func<IServiceCollection, T, IHealthChecksBuilder> buildHealthChecks)
        where T : HealthCheckSettings
    {
        ...
        var appInsightsSettings = configuration
            .GetSection(ApplicationInsightsSettings.ApplicationInsightsSectionName)
        ...
        healthChecks.AddPrivateMemoryHealthCheck(1024 * 1024 * healthCheckSettings.MaximumAllowedMemoryInMegaBytes,
        ...
        {
            services.AddAuthorization(options => options.AddPolicy(HealthChecksTokenRequirement.Name,
                policy => policy.Requirements.Add(
                    new HealthChecksTokenRequirement(healthCheckSettings.RequiredToken))));
